...
}, this._views.OFFLINELIST = {
kindName: "hpit.views.OffLineListView"
};
for (var e in this._views) this._views[e].index = -1;
},
bindPanelsControl: function(e) {
this._panels = e, this.initViewList();
},
...
setView: function(e) {
var t = this._panels;
this._panels.getActive() && this._history.push(t.getIndex());
var n = this._views[e];
if (n.index == -1) {
n.index = this._panelCount++;
var r = t.createComponent({
kind: n.kindName
});
r.render(), t.reflow();
}
return t.setIndex(n.index), t.children[n.index == -1 ? 0 : n.index];
},
isBackable: function() {
...
var t = Utility._appMain.$.notifyHolder.createComponent({
name: "notice",
kind: "com.hpit.control.toast"
}, {
owner: Utility._appMain.$.notifyHolder
});
t.setNotifyCont(e), setTimeout(function() {
Utility._appMain.$.notifyHolder.destroyClientControls(), Utility._appMain.$.notifyHolder.hide();
}, 3e3), Utility._appMain.$.notifyHolder.render();
},
showAlert: function(e) {
this._appMain != null && (this._appMain.$.alert.setMessage(e), this._appMain.$.alert.show());
}
};
...
} else if (enyo.dom.canAccelerate) {
switch (n) {
case 0:
i = 0;
break;
...
if (enyo.dom.canAccelerate) {
var o = t;
e.applyStyle(this.vendor + "transform-origin", "50% 50% -" + this.containerBounds.width / 2 + "px"), e.applyStyle(this.vendor + "transform", "rotateY(" + o + "deg)");
} else {
var u = n, a = r;
e.applyStyle(this.vendor + "transform", "translateX(" + u + "%) scale(" + a + ", 1)");
}
enyo.Arranger.opacifyControl(e, i);
},
getVendor: function() {
...
destroy: function() {
var e = this.container.children;
for (var t = 0, n; n = e[t]; t++) this.flipControl(n, 0, 1), n.setShowing(!0), n.resized();
this.inherited(arguments);
},
arrange: function(e, t) {
...
n != null && r != null && this.flipControl(e, n, r);
},
flipControl: function(e, t, n) {
var r = t, i = n;
enyo.dom.canAccelerate ? e.applyStyle(this.vendor + "transform", "rotateY(" + r + "deg)") : (r <= 0 ? e.applyStyle("display", "none") : e.applyStyle("display", "block"), e.applyStyle(this.vendor + "transform", "scale(" + r + ",1)")), enyo.Arranger.opacifyControl(e, n);
},
getVendor: function() {
var e = "", t = [ "transform", "WebkitTransform", "MozTransform", "OTransform", "msTransform" ], n = document.createElement("div");
for (i = 0; i < t.length; i++) {
...
destroy: function() {
var e = this.container.children;
for (var t = 0, n; n = e[t]; t++) this.pageSpinControl(n, 0, 1, 1), n.setShowing(!0), n.resized();
this.inherited(arguments);
},
arrange: function(e, t) {
...
i != null && this.pageSpinControl(e, n, r, i);
},
pageSpinControl: function(e, t, n, r) {
var i = r;
if (enyo.dom.canAccelerate) {
var s = t;
...
enyo.Arranger.opacifyControl(e, r);
},
getVendor: function() {
var e = "", t = [ "transform", "WebkitTransform", "MozTransform", "OTransform", "msTransform" ], n = document.createElement("div");
for (i = 0; i < t.length; i++) {
...
destroy: function() {
var e = this.container.children;
for (var t = 0, n; n = e[t]; t++) this.pageTurnControl(n, 0, 0, 0, 1), n.setShowing(!0), n.resized();
this.inherited(arguments);
},
arrange: function(e, t) {
for (var n = 0, r; r = e[n]; n++) {
var i = n == e.length - 1 ? 0 : 1;
if (enyo.dom.canAccelerate) {
var s = n == e.length - 1 ? -90 : 0;
this.arrangeControl(r, {
angle: s,
opacity: i
});
} else {
var o = n == e.length - 1 ? -0.2 : 1;
this.arrangeControl(r, {
scale: o,
opacity: i
});
...
this.inherited(arguments);
var e = this.container.children;
for (var t = 0, n; n = e[t]; t++) n.setShowing(t == this.container.fromIndex || t == this.container.toIndex), n.applyStyle("z-index", -t), n.showing && n.resized();
this.vendor || (this.vendor = this.getVendor());
},
finish: function() {
this.inherited(arguments);
...
enyo.Arranger.positionControl(e, t);
var n = t.angle, r = t.scale, i = t.opacity;
i != null && this.pageTurnControl(e, n, r, i);
},
pageTurnControl: function(e, t, n, r) {
var i = r;
if (enyo.dom.canAccelerate) {
var s = t;
e.applyStyle(this.vendor + "transform-origin", "0 50% 0"), e.applyStyle(this.vendor + "transform", "rotateY(" + s + "deg)");
...
var o = n;
e.applyStyle(this.vendor + "transform-origin", "0 50%"), e.applyStyle(this.vendor + "transform", "scale(" + o + ", 1)");
}
enyo.Arranger.opacifyControl(e, r);
},
getVendor: function() {
...
destroy: function() {
var e = this.container.children;
for (var t = 0, n; n = e[t]; t++) this.sladeControl(n, 0, 1), n.setShowing(!0), n.resized();
this.inherited(arguments);
},
arrange: function(e, t) {
for (var n = 0, r, i, s; r = e[n]; n++) {
...
create: function() {
this.inherited(arguments), this.reloadData();
},
reloadData: function() {
var e;
...
Utility.hideScrim(), this.data = t, this.$.newsList.setCount(this.data.length), this.$.newsList.refresh();
}), t.error(this, function() {
Utility.hideScrim(), console.log("HomeView: Get data.json error");
}), Utility.showScrim(), t.go({});
},
...
kind: "onyx.Button",
content: "Offline",
ontap: "offlineListTapped",
classes: "offline-button"
} ]
}, {
kind: "hpit.controls.Body",
components: [ {
classes: "news-title detail-item",
components: [ {
tag: "div",
content: "Subject:",
classes: "detail-padding"
}, {
tag: "div",
name: "newsTitle"
} ]
...
classes: "news-title video-title"
}, {
tag: "img",
classes: "download-img",
...
back: function(e) {
ViewLibrary.setView("HOME"), $("#video_player")[0].pause();
},
offlineListTapped: function() {
var e = ViewLibrary.setView("OFFLINELIST");
...
}, r.download(t, i, function(e) {
console.log("download complete: " + e.fullPath);
}, function(e) {
console.log("download error source " + e.source), console.log("download error target " + e.target), console.log("upload error code" + e.code);
}, !1, {
headers: {}
});
}
...
back: function() {
var e = ViewLibrary.setView("DETAIL");
},
dataChanged: function() {
this.$.offlineList.setCount(this.data.length), this.$.offlineList.refresh();
},
setupItem: function(e, t) {
var n = t.index, r = this.data[n];
this.$.videoName.setContent(r.fileName), this.$.progressBar.setProgress(r.progress.toFixed(2)), this.$.downloadedPart.setContent(this.fileSizeFormat(r.loaded / 2) + "/" + this.fileSizeFormat(r.total)), this.$.percentage.setContent("(" + r.progress.toFixed(2) + "%)");
},
itemTap: function(e, t) {
var n = t.index, r = this.data[n];
r.progress.toFixed(2) == 100 && (location.href = this.data[n].filePath);
},
fileSizeFormat: function(e) {
return e >= 1048576 ? (e / 1048576).toFixed(2) + "MB" : e > 1024 && e < 1048576 ? (e / 1024).toFixed(2) + "KB" : e.toFixed(2) + "B";
}
});
...
create: function() {
this.inherited(arguments), this.$.backButton.setShowing(ViewLibrary.isBackable());
},
rendered: function() {
this.inherited(arguments);
},
...
onyx.customFloatingScrim = new onyx.FloatingLayer({
name: "floatingScrim",
classes: "customFloatingScrim"
}), enyo.kind({
name: "hpit.controls.Scrim",
rendered: function() {
this.inherited(arguments), this.setParent(onyx.customFloatingScrim), this.setStyles(), onyx.customFloatingScrim.render();
},
show: function() {
...
setStyles: function() {
var e = getComputedStyle(document.body, null), t = parseInt(e["margin-top"], 10), n = parseInt(e["margin-left"], 10);
onyx.customFloatingScrim.applyStyle("height", this.calcViewportSize().height + t + "px");
},
...
name: "dialogMessage",
allowHtml: !0,
classes: "controls-alert-message"
} ]
}, {
...
kind: "hpit.controls.Alert",
name: "alert",
showing: !1
}, {
name: "notifyHolder",
classes: "toast-notifyHolder",
showing: !1
}, {
kind: "Panels",
name: "mainPanels",
...
GlobalVar = {}, GlobalVar.mock = !1, GlobalVar.offlinelist = [], GlobalVar.OffLineListView = {};
